...
typedef int (*nna_run_model_func)(void* model, int batchSize, int width, int height, int nchan, const void* data, void** async_handle);
typedef int (*nna_wait_for_job_func)(void* async_handle, uint32_t max_wait_milliseconds);
typedef int (*nna_get_object_detections_func)(void* async_handle, uint32_t max_wait_milliseconds, int maxDetections, NNMObjectDetection* detections, int* numDetections);
typedef void (*nna_finish_run_func)(void* async_handle);
...
int         nna_run_model(void* model, int batchSize, int width, int height, int nchan, const void* data, void** async_handle);
