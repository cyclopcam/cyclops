...
static void detect_yolov7(ncnn::Net& net, int target_size, float prob_threshold, float nms_threshold, const cv::Mat& in_img, std::vector<Object>& objects) {
...
void DetectYOLOv7(ncnn::Net& net, int target_size, float prob_threshold, float nms_threshold, const cv::Mat& img, std::vector<Detection>& objects) {
	std::vector<Object> obj;
	detect_yolov7(net, target_size, prob_threshold, nms_threshold, img, obj);
